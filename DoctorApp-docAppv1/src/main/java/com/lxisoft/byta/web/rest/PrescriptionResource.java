...
public class PrescriptionResource {
  ...
  //  @Timed
    public Prescription createPrescription(@RequestBody Prescription prescription) throws URISyntaxException {
      ...
      /*  if (prescription.getId() != null) {
        ...
        return  result;/*ResponseEntity.created(new URI("/api/prescriptions/" + result.getId()))
  ...
  //  @Timed
    public Prescription updatePrescription(@RequestBody Prescription prescription) throws URISyntaxException {
    ...
    public Prescription getPrescription(@PathVariable Long id) {
        ...
        return  prescription;/*ResponseUtil.wrapOrNotFound(Optional.ofNullable(prescription));*/
    }
